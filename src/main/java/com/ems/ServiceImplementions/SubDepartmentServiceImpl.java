...
import com.ems.Exception.SubDepartmentAlreadyExistsException;
...
public class SubDepartmentServiceImpl implements SubDepartmentService {
	    ...
	    public String saveSubDepartment(SubDepartmentEntity subDepartmentEntity, Long departmentId) {
	    	 if (subDepartmentEntity.getSubDepartmentId() != null && subDepartmentRepository.existsById(subDepartmentEntity.getSubDepartmentId())) {
		            throw new SubDepartmentAlreadyExistsException(subDepartmentEntity.getSubDepartmentId());
		        }
		        DepartmentEntity department = departmentRepository.findById(departmentId)
		                .orElseThrow(() -> new DepartmentNotFoundException(departmentId));
		        subDepartmentEntity.setDepartment(department);
		        subDepartmentRepository.save(subDepartmentEntity);
		        return "subDepartment created successfully with ID: " + subDepartmentEntity.getSubDepartmentId() + " for Dpartment ID: " + departmentId;
		    }
